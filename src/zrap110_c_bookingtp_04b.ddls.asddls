...
define view entity ZRAP110_C_BOOKINGTP_04B
  as projection on ZRAP110_R_BOOKINGTP_04B
{
  ...
  key     BookingID,
          ...
          _BookingStatus._Text.Text as BookingStatusText : localized, //element added
                    ...
                    @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_BOOK_ELEM_04B'
          ...
          // public associations
          _Travel : redirected to parent ZRAP110_C_TRAVELTP_04B,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
