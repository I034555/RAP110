...
**************************************************************************
  METHOD getDaysToFlight.
    DATA:
      c_booking_entity TYPE ZRAP110_C_BookingTP_04B,
      bookings_result  TYPE TABLE FOR FUNCTION RESULT zrap110_r_traveltp_04B\\booking~getdaystoflight,
...
*         ALL FIELDS
    ...
    LOOP AT bookings ASSIGNING FIELD-SYMBOL(<booking>).
      ...
      booking_result-%param
        = CORRESPONDING #( zrap110_calc_book_elem_04B=>calculate_days_to_flight( c_booking_entity )
...
**************************************************************************
  METHOD setInitialBookingValues.
    ...
    DATA: update TYPE TABLE FOR UPDATE zrap110_r_traveltp_04B\\Booking.
