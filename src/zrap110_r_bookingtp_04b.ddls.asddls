...
define view entity ZRAP110_R_BOOKINGTP_04B
  as select from ZRAP110_ABOOK04B as Booking
  association to parent ZRAP110_R_TRAVELTP_04B as _Travel on $projection.TravelID = _Travel.TravelID
