CLASS zrap110_eml_playground_04b DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap110_eml_playground_04b IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    "declare internal table using derived type
    DATA travel_keys TYPE TABLE FOR READ IMPORT ZRAP110_R_TravelTP_04B .

    "fill in relevant travel keys for READ request
    travel_keys = VALUE #( ( TravelID = '4145' )
                          "( TravelID = '...' )
                         ).

    "insert your coding here
    "read _travel_ instances for specified key
    READ ENTITIES OF ZRAP110_R_TravelTP_04B
      ENTITY Travel
*        ALL FIELDS
