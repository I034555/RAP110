...
**********************************************************************
CLASS lsc_zrap110_r_traveltp_04B DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zrap110_r_traveltp_04B IMPLEMENTATION.
  ...
  METHOD adjust_numbers.
    ...
    IF mapped-booking IS NOT INITIAL.
      READ ENTITIES OF ZRAP110_R_TravelTP_04B IN LOCAL MODE
      ...
      LOOP AT mapped-booking INTO DATA(mapped_booking) GROUP BY mapped_booking-TravelID.
        SELECT MAX( booking_id ) FROM zrap110_abook04B WHERE travel_id = @mapped_booking-TravelID INTO @DATA(max_booking_id) .
  ...
  METHOD save_modified.
    ...
    IF update IS NOT INITIAL.
      ...
      "raise event
      RAISE ENTITY EVENT ZRAP110_R_TravelTP_04B~travel_accepted
       FROM VALUE #(
      ...
      "raise event
      RAISE ENTITY EVENT ZRAP110_R_TravelTP_04B~travel_rejected
       FROM VALUE #(
         FOR travel IN update-travel
         WHERE ( %control-OverallStatus EQ if_abap_behv=>mk-on AND
...
**************************************************************************
  METHOD acceptTravel.
    MODIFY ENTITIES OF ZRAP110_R_TravelTP_04B IN LOCAL MODE
         ENTITY travel
...
**************************************************************************
  METHOD setInitialTravelValues.
    ...
    DATA: update TYPE TABLE FOR UPDATE zrap110_r_traveltp_04b\\Travel.
