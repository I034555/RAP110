CLASS zrap110_calc_trav_elem_04B DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_trav_status_ind
        IMPORTING is_original_data TYPE ZRAP110_C_TravelTP_04B
        RETURNING VALUE(result)    TYPE ZRAP110_C_TravelTP_04B.

  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.

CLASS zrap110_calc_trav_elem_04b IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'OVERALLSTATUSINDICATOR'.
          ...
          DATA lt_trav_original_data TYPE STANDARD TABLE OF ZRAP110_C_TravelTP_04B WITH DEFAULT KEY.
          ...
          LOOP AT lt_trav_original_data ASSIGNING FIELD-SYMBOL(<fs_trav_original_data>).
            <fs_trav_original_data> = zrap110_calc_trav_elem_04B=>calculate_trav_status_ind( <fs_trav_original_data> ).
          ENDLOOP.
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZRAP110_C_TRAVELTP_04B'. "Travel BO node
