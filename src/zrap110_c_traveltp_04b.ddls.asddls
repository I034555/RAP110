...
define root view entity ZRAP110_C_TRAVELTP_04B
  provider contract transactional_query
  as projection on ZRAP110_R_TRAVELTP_04B
{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_TRAV_ELEM_04B'
  ...
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZRAP110_C_BOOKINGTP_04B,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
